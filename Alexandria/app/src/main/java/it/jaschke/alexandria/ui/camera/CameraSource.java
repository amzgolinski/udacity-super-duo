    ...
    synchronized (mCameraLock) {
      ...
      if (mCamera != null) {
        ...
        try {
          ...
          // if the developer wants to display a preview we must use a SurfaceHolder.  If the
          // developer doesn't want to display a preview we use a SurfaceTexture if we are running
          // at least Honeycomb.
